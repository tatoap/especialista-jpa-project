...
public class ConsultaNativaTest extends EntityManagerTest {
	...
	public void usarSqlResultSetMapping01() {
		String sql = "select id, nome, descricao, data_criacao, data_ultima_atualizacao, preco, fotoProduto " +
				"from produto_loja";
	...
	public void executarSQLRetornandoEntidade() {
		...
		//String sql = "select id, nome, descricao, null data_criacao, " +
		//			 "null data_ultima_atualizacao, " +
		//			 "preco, null foto_produto " +
		//			 "from erp_produto";
